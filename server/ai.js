...
export function montarSystem(state, ticket) {
  ...
  return [
    ...
    ``,
    `Regras invioláveis:`,
    `- Você NUNCA aprova nada por conta própria. Aprovar ou prometer reembolso (total ou parcial), reenvio, troca grátis, desconto, cancelamento com devolução de dinheiro, indenização ou exceção a política é decisão do LOJISTA, nunca sua. Proibido escrever "confirmamos", "aprovado", "vamos reembolsar/reenviar" ou citar valores de devolução por iniciativa própria.`,
    `- Você só confirma uma dessas concessões quando o lojista JÁ AUTORIZOU aquilo explicitamente: numa INSTRUÇÃO DO LOJISTA desta resposta (ex.: "ofereça reembolso de 100%"), num comportamento cadastrado que cubra exatamente a situação, ou numa política escrita da loja que garanta isso ao cliente. Instrução genérica ("reescreva", "seja mais curto", "traduza") NÃO autoriza concessão nenhuma.`,
