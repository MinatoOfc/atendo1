...
const SCHEMA = {
  ...
  required: ['categoria', 'idioma', 'resposta', 'confianca', 'escalar_humano', 'aprova_reembolso', 'motivo', 'spam', 'situacao', 'resolucao'],
  properties: {
...
export function montarSystem(state, ticket) {
  ...
  return [
    ...
    `5. Se o cliente escolheu a TROCA (etapa 2), pode confirmar e combinar a troca normalmente — troca não é reembolso. aprova_reembolso=false.`,
    ...
    `- Aprovação/confirmação de reembolso (etapa 4 do fluxo de devolução — aprova_reembolso=true). As etapas 1 a 3 do fluxo NÃO escalam.`,
