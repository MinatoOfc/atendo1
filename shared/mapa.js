...
export const MAPA_VISUAL = [
  ...
  r('delivery-delivered-report', 'Marcado como entregue, mas cliente não recebeu', 'nr_entregue', 'Após 2 dias sem entrega: destacar no relatório', 'Confirmar que não houve entrega e seguir para a resolução.', 'regra', null, ['delivery-delivered-reship20', 'delivery-delivered-reship35']),
  r('delivery-delivered-reship20', 'Marcado como entregue, mas cliente não recebeu', 'nr_entregue', 'Reenvio expresso + reembolso de 20%', 'Explicar o retorno superior a 17 dias e oferecer reenvio em 4–11 dias. (No Miro, a seta entra direto no 35%; o motor segue o Miro.)', 'oferta', 'nr_reenvio_20', ['delivery-returned-address', 'delivery-delivered-reship35']),
