...
export const ROTULO_TIPO_AUDITORIA = {
  ...
  ia_retomada: 'IA retomada por você',
}
...
export const ITENS_CHECKLIST = [
  ...
  ['direcao_ajuste', 'Direção do ajuste comprovada pelo cliente'],
  ['tamanho_coerente', 'Tamanho oferecido coerente'],
  ['variante_catalogo', 'Variante conferida no catálogo'],
