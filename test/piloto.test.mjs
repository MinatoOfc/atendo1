...
globalThis.fetch = async (url, opts) => {
  ...
  if (req.includes('intencao')) return responder({ intencao: 'pede_reembolso', motivo: 'qualidade', produtos: [], ajustes: [], situacaoEntrega: 'nenhuma', endereco: '', resumo: 'msg', idioma: 'de', idiomaConfiavel: true, spam: false })
